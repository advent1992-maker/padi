...
$instrumen_siswa = [
    'A. Aspek Materi PJOK' => [
        'Materi PJOK dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Permainan atau kuis di dalam PJOK sangat menantang.',
        'Media ini membuat belajar PJOK menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
        'Setelah menggunakan media ini, saya lebih mengerti materi PJOK.',
...
<head>
    <meta charset="UTF-8">
    <title>Evaluasi Materi | PJOK</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">PJOK Semester 2 - PJOK Menyenangkan</p>
