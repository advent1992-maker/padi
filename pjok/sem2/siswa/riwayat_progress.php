...
<head>
    ...
    <title>Riwayat Progress Siswa | PJOK</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        body { background-color: #fff5f5; }
        /* Warna Merah Pancasila */
        .header-red { background-color: #fd7e14; color: white; padding: 30px 0; }
        ...
        .btn-red { background-color: #fd7e14; color: white; }
        .btn-red:hover { background-color: #fd7e14; color: white; }
        .text-red { color: #fd7e14; }
    </style>
</head>
<body>
