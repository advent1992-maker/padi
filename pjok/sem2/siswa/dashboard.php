...
<head>
    ...
    <title>Dashboard Siswa | PJOK</title>
    ...
    .hero-card {
        background: <?= $is_archive ? 'linear-gradient(135deg, #6c757d, #495057)' : 'linear-gradient(135deg, #fd7e14, #e65100)' ?>;
    ...
    /* Style Banner Panduan PJOK */
    .guide-banner-pjok { background: #fff; border: none; border-radius: 15px; border-left: 6px solid #fd7e14; }
...
<nav class="navbar navbar-dark <?= $is_archive ? 'bg-secondary' : 'bg-primary' ?> shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">PJOK | SISWA</a>
...
<div class="container mt-5 mb-5 text-start">
    <div class="hero-card text-center mb-5">
        <h1 class="display-5 fw-bold"><i class="fas fa-skating"></i> Peta Pembelajaran Anda</h1>
        <p class="lead mt-3">Selamat datang kembali, <?php echo htmlspecialchars($nama_pengguna); ?>! Mari selesaikan materi PJOK hari ini bersama <b>Guru <?php echo htmlspecialchars($nama_guru_pembimbing); ?></b>.</p>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card guide-banner-pjok shadow-sm">
                <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h5 class="fw-bold mb-1 text-primary"><i class="fas fa-info-circle me-2"></i> Petunjuk Belajar PJOK</h5>
                        <p class="text-muted mb-0 small">Ikuti panduan belajar, kuis olahraga, dan gunakan bantuan Asisten AI di sini.</p>
                    </div>
                    <button class="btn btn-primary fw-bold px-4 rounded-pill mt-3 mt-md-0 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalPanduanPjok">
    ...
    <div class="row g-4 text-start">
        <div class="col-md-6 mb-3">
            <div class="stat-card p-4 h-100">
                ...
                <p>Pilih materi PJOK yang ingin Anda kuasai hari ini.</p>
                <a href="materi.php" class="btn btn-primary w-100 btn-lg rounded-pill">
                    <i class="fas fa-running"></i> Lihat Materi
                </a>
            </div>
        </div>
        <div class="col-md-6 mb-3">
        ...
        <!--            <i class="fas fa-comment-dots me-2"></i> Isi Penilaian-->
        <!--        </a>-->
        <!--    </div>-->
        <!--</div>-->
    </div>
...
<div class="modal fade" id="modalPanduanPjok" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header border-0 p-4 pb-0 text-start">
                <h5 class="fw-bold text-primary"><i class="fas fa-running me-2"></i> Alur Belajar PJOK</h5>
            ...
            <div class="modal-body p-4 text-start">
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Pilih Materi Olahraga</h6>
                        <p class="small text-muted mb-0">Klik <b>Lihat Materi</b>, pelajari tekniknya, dan selesaikan kuisnya.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="small text-muted mb-0">Tanya <b>Kak PADI AI</b> di pojok kanan bawah jika butuh tips olahraga atau kesehatan.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Uji Diri & Peringkat</h6>
                        <p class="small text-muted mb-0">Selesaikan <b>Tryout</b> dan pantau namamu di daftar <b>Leaderboard</b>.</p>
                    </div>
                </div>
            </div>
...
<div id="ai-chat-container">
    <div id="ai-chat-window">
        <div class="chat-header">
            <span><i class="fas fa-robot me-2"></i> Asisten PADI PJOK</span>
            <button class="btn-close btn-close-white" onclick="toggleChat()"></button>
        </div>
        <div class="chat-body" id="chatBody">
            <div class="msg msg-ai">Halo <strong><?= htmlspecialchars($nama_pengguna) ?></strong>! Ada yang ingin ditanyakan seputar teknik olahraga atau kesehatan tubuh? Bapak bantu ya! 😊</div>
            <div id="typingIndicator" class="typing">PADI AI sedang berpikir...</div>
        </div>
        <div class="chat-footer">
            <input type="text" id="chatInput" class="form-control form-control-sm" placeholder="Tanya tentang PJOK..." onkeypress="handleKeyPress(event)">
...
<script>
    ...
    try {
        const response = await fetch('proses_ai_asisten.php', {
            ...
            body: JSON.stringify({ 
                pesan: pesan,
                mapel: 'pjok' // TAMBAHKAN BARIS INI AGAR AI TAHU LOKASINYA
            })
        });
