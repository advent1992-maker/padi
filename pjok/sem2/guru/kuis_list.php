<?php
// ======================================================================================
// KUIS_LIST.PHP (SISI GURU) - Menampilkan Materi Pribadi dan Adopsi untuk Kelola Soal
// ======================================================================================
...
// --- LOGIKA BARU: PROSES TOGGLE TAMPILKAN/SEMBUNYIKAN ---
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Soal Kuis | PJOK</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php"><strong>PJOK | GURU</strong></a>
...
<div class="container mt-5">
    <header class="mb-4">
        <h1><i class="fas fa-question-circle text-primary"></i> Kelola Soal Kuis</h1>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-primary">
                    <tr>
                        <th>#</th><th>Judul Bab Cerita</th><th>Status Kuis</th><th>Kelas</th><th class="text-center">Jumlah Soal</th><th class="text-center">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($materi_pribadi)): ?>
                        <tr><td colspan="6" class="text-center p-4">Anda belum membuat materi pribadi untuk kelas <?= $kelas_diajar_str ?>.</td></tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($m['tampilkan_kuis'] == 1): ?>
                                    <a href="?toggle_id=<?= $m['id'] ?>&status=1" class="btn btn-sm btn-light border text-success fw-bold">
                                        <i class="fas fa-eye"></i> Tampil
                                    </a>
                                <?php else: ?>
                                    <a href="?toggle_id=<?= $m['id'] ?>&status=0" class="btn btn-sm btn-secondary fw-bold">
                                        <i class="fas fa-eye-slash"></i> Sembunyi
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td><span class="badge bg-success">Kelas <?= $m['level_kategori'] ?></span></td>
    ...
    <!--<h4 class="text-primary mb-3"><i class="fas fa-star"></i> Materi Guru Lain (Hanya Lihat)</h4>-->
    <!--<div class="card card-table shadow-sm">-->
    <!--    <div class="table-responsive">-->
    <!--        <table class="table table-hover align-middle mb-0">-->
    <!--            <thead class="table-dark">-->
    <!--                <tr><th>#</th><th>Judul Bab Cerita</th><th>Kelas</th><th class="text-center">Aksi</th></tr>-->
    <!--            </thead>-->
    <!--            <tbody>-->
    <!--                <?php if (empty($materi_adopsi)): ?>-->
    <!--                    <tr><td colspan="4" class="text-center p-4">Tidak ada materi adopsi tersedia.</td></tr>-->
