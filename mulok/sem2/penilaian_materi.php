...
$instrumen_siswa = [
    'A. Aspek Materi MULOK' => [
        'Materi mulok Budaya Komering dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Permainan atau kuis di dalam Materi ini sangat menantang.',
        'Media ini membuat belajar Mulok Budaya komering menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
        'Setelah menggunakan media ini, saya lebih mengerti materi Mulok Budaya Komering.',
...
<head>
    <meta charset="UTF-8">
    <title>Evaluasi Materi | MULOK (B.KOMERING)</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Mulok B.Komering Semester 2 - Belajar B.Komering Menyenangkan</p>
