...
<head>
    ...
    <title>Riwayat Progress Siswa | B.Komering</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        body { background-color: #fff5f5; }
        /* Warna Merah Pancasila */
        .header-red { background-color: #4b4b4b; color: white; padding: 30px 0; }
        ...
        .btn-red { background-color: #4b4b4b; color: white; }
        .btn-red:hover { background-color: #4b4b4b; color: white; }
        .text-red { color: #4b4b4b; }
    </style>
</head>
<body>
...
<div class="container mt-4 mb-5">
    <a href="dashboard.php" class="btn btn-outline-dark mb-4"><i class="fas fa-arrow-left"></i> Kembali ke Dashboard</a>

    <h4 class="text-grey mb-3"><i class="fas fa-list-alt"></i> Progress & Riwayat Anda (Kelas <?php echo htmlspecialchars($kelas_siswa); ?>)</h4>
