<?php
// ======================================================================================
// KUIS_LIST.PHP (SISI GURU) - MULOK (Dengan Fitur Tampilkan/Sembunyikan Kuis)
// ======================================================================================
...
// --- LOGIKA BARU: PROSES TOGGLE STATUS TAMPIL/SEMBUNYI ---
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Soal Kuis | MULOK</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php"><strong>MULOK | GURU</strong></a>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (empty($materi_pribadi)): ?>
                        <tr><td colspan="6" class="text-center p-4">Belum ada materi pribadi MULOK.</td></tr>
