<?php
// ======================================================================================
// KUIS_LIST.PHP (SISI GURU) - MATEMATIKA (Fitur Tampilkan/Sembunyikan Kuis)
// ======================================================================================
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Soal Kuis | MATEMATIKA</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php"><strong>MATEMATIKA | GURU</strong></a>
...
<div class="container mt-5">
    <header class="mb-4">
        <h1><i class="fas fa-calculator text-primary"></i> Kelola Soal Kuis</h1>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (empty($materi_pribadi)): ?>
                        <tr><td colspan="5" class="text-center p-4">Belum ada materi matematika pribadi.</td></tr>
