...
<head>
    ...
    <title>Riwayat Progress Siswa | MATHFICTION</title>
...
<div class="container mt-4 mb-5">
    ...
    <h4 class="text-primary mb-3"><i class="fas fa-list-alt"></i> Progress & Riwayat Anda (Kelas <?php echo htmlspecialchars($kelas_siswa); ?>)</h4>
