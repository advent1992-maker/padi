...
// Ambil info tryout
$stmt = $db_mapel->prepare("SELECT judul, waktu_alokasi FROM tryout_master WHERE id = ?");
...
// Ambil semua soal
$stmt_soal = $db_mapel->prepare("SELECT * FROM soal_tryout WHERE tryout_id = ? ORDER BY id ASC");
