...
<head>
    ...
    <title>Dashboard Siswa | MATHFICTION</title>
    ...
    <style>
        ...
        .hero-card {
            background: <?= $is_archive ? 'linear-gradient(135deg, #6c757d, #495057)' : 'linear-gradient(135deg, #0d6efd, #0b5ed7)' ?>;
        ...
        /* Style Petunjuk Matematika */
        .guide-banner-math { background: #fff; border: none; border-radius: 15px; border-left: 6px solid #0d6efd; }
...
<nav class="navbar navbar-dark <?= $is_archive ? 'bg-secondary' : 'bg-primary' ?> shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">MATHFICTION | SISWA</a>
...
<div class="container mt-5 mb-5 text-start">
    <div class="hero-card text-center mb-5">
        <h1 class="display-5 fw-bold"><i class="fas fa-calculator"></i> Peta Pembelajaran Matematika</h1>
        <p class="lead mt-3">Selamat datang kembali, <?php echo htmlspecialchars($nama_pengguna); ?>! Mari selesaikan materi Matematika hari ini bersama <b>Guru <?php echo htmlspecialchars($nama_guru_pembimbing); ?></b>.</p>
        <p class="fs-4">Anda berada di <b>Kelas <?php echo htmlspecialchars($level_kelas); ?></b>.</p>
        <a href="../../../dashboard.php" class="btn btn-light mt-2 fw-bold text-primary rounded-pill">
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card guide-banner-math shadow-sm">
                <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h5 class="fw-bold mb-1 text-primary"><i class="fas fa-lightbulb me-2"></i> Petunjuk Belajar Matematika</h5>
                        <p class="text-muted mb-0 small">Klik tombol di samping untuk panduan cara belajar, mengerjakan kuis, dan bantuan AI.</p>
                    </div>
                    <button class="btn btn-primary fw-bold px-4 rounded-pill mt-3 mt-md-0 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalPanduanMath">
    ...
    <div class="row text-center mb-5">
        ...
        <div class="col-md-4 mb-3">
            <div class="stat-card">
                ...
                <h1 class="text-primary my-3 fw-bold"><?php echo $skor_rata_rata_tampil; ?></h1>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        <div class="col-md-6">
            <div class="stat-card p-4 h-100">
                ...
                <p class="text-muted">Pilih materi matematika yang ingin Anda taklukkan hari ini.</p>
                <a href="materi.php" class="btn btn-primary w-100 btn-lg rounded-pill">
                    <i class="fas fa-map-marked-alt me-2"></i> Lihat Materi
                </a>
            </div>
        </div>
        <div class="col-md-6">
            <div class="stat-card p-4 h-100">
                ...
                <p class="text-muted">Cek semua upaya kuis Anda, skor, dan Pembahasan.</p>
                <a href="riwayat_progress.php" class="btn btn-success w-100 btn-lg rounded-pill">
        ...
        <div class="col-md-6">
            <div class="stat-card p-4">
                ...
                <p class="text-muted">Pilih kategori ujian: Harian, Tengah Semester, atau Semester.</p>
        ...
        <div class="col-md-6">
            <div class="stat-card p-4">
                ...
                <p class="text-muted">Yukk Periksa Peringkatmu!</p>
        ...
        <!--        <p class="text-muted">Bantu kami meningkatkan media dengan memberikan penilaian jujur Anda.</p>-->
...
<div class="modal fade" id="modalPanduanMath" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header border-0 p-4 pb-0">
                <h5 class="fw-bold text-primary"><i class="fas fa-calculator me-2"></i> Cara Belajar Matematika</h5>
            ...
            <div class="modal-body p-4 text-start">
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Pelajari Bab Baru</h6>
                        <p class="small text-muted mb-0">Klik <b>Lihat Materi</b>, pelajari materinya, lalu kerjakan kuisnya.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="small text-muted mb-0">Jika bingung dengan rumus atau cara pengerjaan, tanya <b>Kak PADI AI</b> di pojok kanan bawah.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    <div class="bg-success text-white rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="width: 45px; height: 45px; flex-shrink: 0; font-weight: bold; background-color: #28a745 !important;">3</div>
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Pantau Nilaimu</h6>
                        <p class="small text-muted mb-0">Buka menu <b>Riwayat</b> untuk melihat kuis apa saja yang sudah kamu kerjakan.</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer border-0 p-4 pt-0">
                <button type="button" class="btn btn-primary w-100 rounded-pill py-2 fw-bold" data-bs-dismiss="modal">SAYA SIAP!</button>
            </div>
        </div>
    </div>
</div>
...
<div id="ai-chat-container">
    <div id="ai-chat-window">
        <div class="chat-header">
            <span><i class="fas fa-robot me-2"></i> Asisten PADI Matematika</span>
            <button class="btn-close btn-close-white" onclick="toggleChat()"></button>
        </div>
        <div class="chat-body" id="chatBody">
            <div class="msg msg-ai">Halo <strong><?= htmlspecialchars($nama_pengguna) ?></strong>! Ada soal matematika yang sulit? Kak PADI bantu jelaskan caranya ya! 😊</div>
            <div id="typingIndicator" class="typing">PADI AI sedang berpikir...</div>
        </div>
        <div class="chat-footer">
            <input type="text" id="chatInput" class="form-control form-control-sm" placeholder="Tanya tentang Matematika..." onkeypress="handleKeyPress(event)">
