...
<head>
    ...
    <title><?= $materi ? htmlspecialchars($materi['judul']) : 'Materi'; ?> | MATHFICTION</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        body { background-color: #eef5ff; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .result-card { border: 1px solid #dee2e6; border-left: 5px solid #0d6efd; padding: 15px; border-radius: 8px; background-color: #f8f9fa; }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="dashboard.php">MATHFICTION</a>
        ...
        <a href="../logout.php" class="btn btn-sm btn-light fw-bold text-primary">Keluar</a>
    </div>
</nav>
...
<div class="container mt-3 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        <div>
            <h4 class="text-primary mb-1"><?php echo htmlspecialchars($materi['judul']); ?></h4>
            <p class="text-muted small mb-0">Target Kelas <?php echo $materi['level_kategori']; ?> | <?php echo htmlspecialchars($materi['deskripsi']); ?></p>
        </div>
                ...
                <script>
                    (function() {
                        ...
                        try {
                            ...
                            const fullHTML = `<html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"><style>body{margin:0;padding:20px;overflow-x:hidden;}</style></head><body>${html}</body></html>`;
                ...
                <?php if ($materi['tampilkan_kuis'] == 1): ?>
                    <div class="alert alert-info text-center py-4 <?= ($jumlah_percobaan >= 5) ? 'limit-reached' : ''; ?>">
                        ...
                        <?php if ($jumlah_percobaan < 5): ?>
                            ...
                            <a href="start_quiz.php?materi_id=<?php echo $materi['id']; ?>" class="btn btn-primary px-4 fw-bold shadow">
                        ...
                        <?php else: ?>
                            <div class="alert alert-danger d-inline-block rounded-pill px-4 mt-2">
                                <i class="fas fa-exclamation-triangle me-2"></i> Maaf, kamu sudah menggunakan 5 kali kesempatan mengerjakan.
                            </div>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
