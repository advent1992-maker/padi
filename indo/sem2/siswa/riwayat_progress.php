...
<head>
    ...
    <title>Riwayat Progress Siswa | B.INDO</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        body { background-color: #f0f8ff; }
        .header-blue { background-color: #e65100; color: white; padding: 30px 0; }
...
<div class="container mt-4 mb-5">
    ...
    <h4 class="text-DARK mb-3"><i class="fas fa-list-alt"></i> Progress & Riwayat Anda (Kelas <?php echo htmlspecialchars($kelas_siswa); ?>)</h4>
