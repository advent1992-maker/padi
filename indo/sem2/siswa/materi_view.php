...
if ($materi_id > 0 && $level_kelas > 0) {
   // Tambahkan tampilkan_kuis setelah konten_materi
...
<head>
    ...
    <title><?= $materi ? htmlspecialchars($materi['judul']) : 'Materi'; ?></title>
    ...
    <style>
        ...
        /* Perbaikan 1: Tinggi ditambah sedikit agar tidak terpotong bawahnya */
        iframe.materi-frame { width: 100%; height: 80vh; border: 1px solid #eee; border-radius: 10px; background: white; }
...
<nav class="navbar navbar-dark bg-primary shadow-sm mb-3">
    <div class="container">
        <a class="navbar-brand fw-bold" href="dashboard.php">B.INDO</a>
            ...
            <?php if (!empty($materi['konten_materi'])): ?>
                ...
                <script>
                    (function() {
                        ...
                        // Perbaikan 2: Decode UTF-8 agar simbol tidak silang/aneh
                        ...
                        // Perbaikan 3: Gunakan Meta Charset UTF-8 saja, tanpa merubah skala font (Adapter dibuang)
                        const fullHTML = `<html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"><style>body{margin:0;padding:0;}</style></head><body>${html}</body></html>`;
