...
$instrumen_siswa = [
    'A. Aspek Materi Bahasa Indonesia' => [
        'Materi B.Indonesia dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Media ini membuat belajar bahasa indonesia menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
        'Setelah menggunakan media ini, saya lebih mengerti pelajaran bahasa Indonesia.',
...
<head>
    <meta charset="UTF-8">
    <title>Evaluasi Materi | .B.INDONESIA</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Bahasa Indonesia Semester 2 - B.Indonesisa Menyenangkan</p>
