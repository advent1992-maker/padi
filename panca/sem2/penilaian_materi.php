...
$instrumen_siswa = [
    'A. Aspek Materi Pendidikan Pancasila' => [
        'Materi pendidikan Pancasila dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Permainan atau kuis di dalam materi pendidikan pancasila ini sangat menantang.',
        'Media ini membuat belajar pendidikan pancasila menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
        'Setelah menggunakan media ini, saya lebih mengerti materi pendidikan pancasila.',
...
<head>
    <meta charset="UTF-8">
    <title>Evaluasi Materi | Pend. Pancasila</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Pendidikan Pancasila Semester 2 - Pend. Pancasila Menyenangkan</p>
