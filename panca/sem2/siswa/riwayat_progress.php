...
$query_kuis_done = "
    ...
    FROM panca_riwayat_kuis hk
    JOIN panca_materi m ON hk.id_materi = m.id
...
$query_tryout_done = "
    ...
    FROM panca_riwayat_tryout rt
    JOIN panca_tryout_master tm ON rt.tryout_id = tm.id
...
$query_kuis_available = "
    ...
    AND id NOT IN (
        SELECT DISTINCT id_materi FROM panca_riwayat_kuis WHERE id_user = ?
    )
";
...
$query_tryout_available = "
    ...
    FROM panca_tryout_master
    WHERE kelas = ? AND id_guru = ?
    AND id NOT IN (
        SELECT DISTINCT tryout_id FROM panca_riwayat_tryout WHERE id_user = ?
    )
";
...
<head>
    ...
    <title>Riwayat Progress Siswa | PEND. PANCASILA</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        body { background-color: #fff5f5; }
        /* Warna Merah Pancasila */
        ...
        .btn-red:hover { background-color: #b02a37; color: white; }
...
<div class="container mt-4 mb-5">
    <a href="dashboard.php" class="btn btn-outline-danger mb-4"><i class="fas fa-arrow-left"></i> Kembali ke Dashboard</a>

    <h4 class="text-red mb-3"><i class="fas fa-list-alt"></i> Progress & Riwayat Anda (Kelas <?php echo htmlspecialchars($kelas_siswa); ?>)</h4>
        ...
        <div class="row">
            ...
            <?php
                ...
                if ($is_done) {
                    ...
                    $button_html = '<a href="' . $detail_link . '" class="btn btn-sm btn-red w-100 mt-2"><i class="fas fa-eye"></i> Lihat Pembahasan</a>';
                ...
                <div class="card shadow progress-card <?php echo $card_class; ?>">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="badge <?php echo $is_tryout ? 'bg-danger' : 'bg-warning text-dark'; ?>">
