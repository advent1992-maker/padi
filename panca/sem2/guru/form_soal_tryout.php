...
$query_master = "SELECT judul, kelas FROM panca_tryout_master WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_soal'])) {
    ...
    $query = "DELETE FROM panca_soal_tryout WHERE id = ? AND tryout_id = ?";
...
$query_soal_list = "SELECT * FROM panca_soal_tryout WHERE tryout_id = ? ORDER BY id ASC";
