...
if (isset($_POST['proses_pindah_soal'])) {
    ...
    if (!empty($selected_soal)) {
        ...
        $sql_import = "INSERT INTO panca_soal_tryout (tryout_id, pertanyaan, gambar_url, opsi_a, opsi_a_gambar_url, opsi_b, opsi_b_gambar_url, opsi_c, opsi_c_gambar_url, opsi_d, opsi_d_gambar_url, jawaban_benar) 
                       ...
                       FROM panca_soal WHERE id IN ($ids)";
            ...
            <form method="POST" class="row g-3 mb-4">
                <div class="col-md-9">
                    <select name="materi_id" class="form-select" onchange="this.form.submit()">
                        ...
                        <?php
                        $materi_list = $db_mapel->query("SELECT id, judul FROM panca_materi WHERE id_guru = $user_id");
            ...
            <form method="POST">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered align-middle">
                        ...
                        <tbody>
                            <?php
                            $soal_list = $db_mapel->query("SELECT * FROM panca_soal WHERE materi_id = $materi_id_terpilih");
