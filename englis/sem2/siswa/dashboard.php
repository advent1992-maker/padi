...
<head>
    ...
    <title>Dashboard Siswa | B. Inggris</title>
    ...
    .hero-card {
        background: <?= $is_archive ? 'linear-gradient(135deg, #6c757d, #495057)' : 'linear-gradient(135deg, #6f42c1, #5a32a3)' ?>;
    ...
    .guide-banner-english { background: #fff; border: none; border-radius: 15px; border-left: 6px solid #6f42c1; }
...
<nav class="navbar navbar-dark <?= $is_archive ? 'bg-secondary' : 'bg-primary' ?> shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">B. INGGRIS | SISWA</a>
...
<div class="container mt-5 mb-5 text-start">
    <div class="hero-card text-center mb-5">
        <h1 class="display-5 fw-bold"><i class="fas fa-language"></i> Peta Pembelajaran Anda</h1>
        <p class="lead mt-3">Selamat datang kembali, <?php echo htmlspecialchars($nama_pengguna); ?>! Mari selesaikan materi B. Inggris hari ini bersama <b>Guru <?php echo htmlspecialchars($nama_guru_pembimbing); ?></b>.</p>
    ...
    <div class="row mb-5">
        <div class="col-12 text-start">
            <div class="card guide-banner-english shadow-sm">
                <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h5 class="fw-bold mb-1 text-primary"><i class="fas fa-info-circle me-2"></i> English Learning Guide</h5>
                        <p class="text-muted mb-0 small">Klik tombol di samping untuk panduan belajar, kuis, dan bantuan AI.</p>
                    </div>
                    <button class="btn btn-primary fw-bold px-4 rounded-pill mt-3 mt-md-0 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalPanduanEnglish">
    ...
    <div class="row text-center mb-5">
        ...
        <div class="col-md-4 mb-3">
            <div class="stat-card h-100">
                <h5 class="card-title text-primary">Total Kuis & Tryout Dikerjakan</h5>
    ...
    <div class="row g-4 text-start">
        <div class="col-md-6 mb-3">
            <div class="stat-card p-4 h-100">
                ...
                <p>Pilih materi Bahasa Inggris yang ingin Anda kuasai hari ini.</p>
        ...
        <div class="col-md-6 mb-3">
            <div class="stat-card p-4 h-100">
                ...
                <p>Cek upaya kuis, skor, dan Pembahasan.</p>
        ...
        <div class="col-md-6 mb-3">
            <div class="stat-card p-4 h-100">
                <h4><i class="fas fa-edit"></i> Mulai Try Out</h4>
        ...
        <div class="col-md-6 mb-3">
            <div class="stat-card p-4 h-100">
                ...
                <p>Yuk, periksa peringkatmu di antara teman-teman!</p>
        ...
        <!--            <i class="fas fa-comment-dots"></i> Isi Penilaian-->
        <!--        </a>-->
        <!--    </div>-->
        <!--</div>-->
    </div>
...
<div class="modal fade" id="modalPanduanEnglish" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header border-0 p-4 pb-0 text-start">
                <h5 class="fw-bold text-primary"><i class="fas fa-flag-usa me-2"></i> English Learning Steps</h5>
            ...
            <div class="modal-body p-4 text-start">
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Open Your Lesson</h6>
                        <p class="small text-muted mb-0">Click <b>Lihat Materi</b> to choose a topic and start reading the materials.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Use AI Assistant</h6>
                        <p class="small text-muted mb-0">Confused with English words? Ask <b>Kak PADI AI</b> at the bottom right corner.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Check Your Result</h6>
                        <p class="small text-muted mb-0">Complete a <b>Tryout</b> and check your rank on the <b>Leaderboard</b>.</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer border-0 p-4 pt-0">
                <button type="button" class="btn btn-primary w-100 rounded-pill py-2 fw-bold" data-bs-dismiss="modal">LET'S START!</button>
            </div>
        </div>
    </div>
</div>
...
<div id="ai-chat-container">
    <div id="ai-chat-window">
        <div class="chat-header">
            <span><i class="fas fa-robot me-2"></i> PADI English Assistant</span>
            <button class="btn-close btn-close-white" onclick="toggleChat()"></button>
        </div>
        <div class="chat-body" id="chatBody">
            <div class="msg msg-ai">Hi <strong><?= htmlspecialchars($nama_pengguna) ?></strong>! Need help with English grammar or vocabulary? Just ask me! 😊</div>
            <div id="typingIndicator" class="typing">AI is thinking...</div>
        </div>
        <div class="chat-footer">
            <input type="text" id="chatInput" class="form-control form-control-sm" placeholder="Ask anything in English..." onkeypress="handleKeyPress(event)">
    ...
    <div class="ai-label shadow-sm" id="aiLabel">Ask Kak PADI AI</div>
</div>
