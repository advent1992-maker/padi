...
if ($id_materi_asal > 0) {
    ...
    try {
        ...
        $stmt = $db_mapel->prepare("SELECT judul, deskripsi, level_kategori, file_path, konten_materi FROM materi WHERE id = ?");
        ...
        $stmt_ins = $db_mapel->prepare("INSERT INTO materi (judul, deskripsi, level_kategori, file_path, konten_materi, id_guru) VALUES (?, ?, ?, ?, ?, ?)");
