...
// Ganti baris 14 dengan ini:
$user_id = $_SESSION['id_guru_pilihan'] ?? (int)($_SESSION['user_id'] ?? 0);
$role = $_SESSION['role'] ?? '';
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Materi | B.INGGRIS</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
        <div class="container">
            <a class="navbar-brand" href="dashboard.php"><strong>B.INGGRIS | GURU</strong></a>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="kuis_form.php?id_materi=<?= $m['id'] ?>" class="btn btn-sm btn-outline-primary">Kelola Kuis</a>
