...
$instrumen_siswa = [
    'A. Aspek Materi bahasa inggris' => [
        'Materi bahasa inggris dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Media ini membuat belajar bahasa inggris menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
...
<head>
    <meta charset="UTF-8">
    <title>Evaluasi Materi | ENGLISH</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">ENGLISH Semester 2 - English Menyenangkan</p>
