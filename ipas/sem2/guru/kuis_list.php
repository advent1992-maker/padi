...
// Cek apakah sedang membuka semester arsip
$mode_arsip = ($semester == '1');

// --- LOGIKA TOGGLE TAMPILKAN/SEMBUNYIKAN ---
if (isset($_GET['toggle_id'])) {

    // Jangan izinkan perubahan jika sedang membuka semester arsip
    if ($semester == '1') {
        die("Mode arsip tidak dapat diubah.");
    }
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Soal Kuis | IPAS</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php"><strong>IPAS | GURU</strong></a>
...
<div class="container mt-5">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (empty($materi_pribadi)): ?>
                        <tr><td colspan="5" class="text-center p-4">Anda belum membuat materi pribadi untuk kelas <?= $kelas_diajar_str ?>.</td></tr>
    ...
    <span class="badge bg-secondary">
        <i class="fas fa-lock"></i> Arsip
    </span>

<?php elseif($m['tampilkan_kuis'] == 1): ?>
...
<?php if(!$mode_arsip): ?>
    ...
    <a href="kuis_form.php?id_materi=<?= $m['id'] ?>"
...
<?php endif; ?>
    ...
    <a href="preview_kuis.php?id_materi=<?= $m['id'] ?>"
