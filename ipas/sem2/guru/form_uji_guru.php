...
$instrumen_guru = [
    'A. Aspek Manajemen Konten & Materi' => [
        'Kemudahan dalam mencari dan memfilter materi/soal yang tersedia.',
...
<head>
    ...
    <title>Penilaian Media IPAS (Guru)</title>
        ...
        <div class="col-lg-11">
            <div class="form-container">
                <header class="text-center mb-5">
                    <h1 class="text-warning fw-bolder"><i class="fas fa-desktop me-2"></i> Formulir Penilaian untuk aplikasi Media IPAS</h1>
