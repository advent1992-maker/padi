...
$instrumen_siswa = [
    'A. Aspek Materi IPAS' => [
        'Materi IPAS dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Permainan atau kuis di dalam materi IPAS ini sangat menantang.',
        'Media ini membuat belajar matematika menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
        'Setelah menggunakan media ini, saya lebih mengerti materi IPAS.',
...
<head>
    <meta charset="UTF-8">
    <title>Evaluasi Materi | IPAS</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">IPAS Semester 2 - IPAS Menyenangkan</p>
