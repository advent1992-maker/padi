...
if (!empty($filter_kelas) && $filter_kelas !== 'semua') {
    ...
    $safe_filter_kelas = $conn->real_escape_string($filter_kelas);
...
$result_global_siswa = $conn->query($query_global_siswa);
...
$result_antar_kelas = $conn->query($query_antar_kelas);
?>
