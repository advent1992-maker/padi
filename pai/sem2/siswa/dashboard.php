...
<head>
    ...
    <title>Dashboard Siswa | PAI</title>
    ...
    /* Tema Toska PAI */
    .bg-primary { background-color: #00acc1 !important; }
    .btn-primary { background-color: #00acc1 !important; border-color: #00acc1 !important; }
    .text-primary { color: #00acc1 !important; }

    .hero-card {
        background: <?= $is_archive ? 'linear-gradient(135deg, #6c757d, #495057)' : 'linear-gradient(135deg, #00acc1, #00838f)' ?>;
    ...
    /* Style Banner Panduan PAI */
    .guide-banner-pai { background: #fff; border: none; border-radius: 15px; border-left: 6px solid #00acc1; }
...
<nav class="navbar navbar-dark <?= $is_archive ? 'bg-secondary' : 'bg-primary' ?> shadow-sm">
    <div class="container">
        <a class="navbar-brand fw-bold" href="#">PAI | SISWA</a>
...
<div class="container mt-5 mb-5 text-start">
    <div class="hero-card text-center mb-5">
        <h1 class="display-5 fw-bold"><i class="fas fa-mosque"></i> Peta Pembelajaran Anda</h1>
        <p class="lead mt-3">Selamat datang kembali, <?php echo htmlspecialchars($nama_pengguna); ?>! Mari selesaikan materi PAI hari ini bersama <b>Guru <?php echo htmlspecialchars($nama_guru_pembimbing); ?></b>.</p>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <div class="card guide-banner-pai shadow-sm">
                <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap">
                    <div>
                        <h5 class="fw-bold mb-1 text-primary"><i class="fas fa-info-circle me-2"></i> Petunjuk Belajar PAI</h5>
                        <p class="text-muted mb-0 small">Pelajari alur materi, kuis, dan gunakan bantuan Asisten AI di sini.</p>
                    </div>
                    <button class="btn btn-primary fw-bold px-4 rounded-pill mt-3 mt-md-0 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalPanduanPai">
    ...
    <div class="row g-4 text-start">
        <div class="col-md-6 mb-3">
            <div class="stat-card p-4 h-100">
                ...
                <p>Pilih materi PAI yang ingin Anda kuasai hari ini.</p>
                <a href="materi.php" class="btn btn-primary w-100 btn-lg rounded-pill">
                    <i class="fas fa-book-reader"></i> Lihat Materi
                </a>
            </div>
        </div>
        <div class="col-md-6 mb-3">
...
<div class="modal fade" id="modalPanduanPai" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none;">
            <div class="modal-header border-0 p-4 pb-0 text-start">
                <h5 class="fw-bold text-primary"><i class="fas fa-mosque me-2"></i> Alur Belajar PAI</h5>
            ...
            <div class="modal-body p-4 text-start">
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="small text-muted mb-0">Klik menu <b>Lihat Materi</b>, pilih bab yang aktif, dan pelajari isinya.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="small text-muted mb-0">Jika bingung dengan materi atau hukum bacaan, tanya <b>Kak PADI AI</b> di pojok kanan bawah.</p>
                    </div>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="fw-bold mb-1">Uji Diri & Leaderboard</h6>
                        <p class="small text-muted mb-0">Kerjakan <b>Tryout</b> dan lihat namamu bersaing di daftar <b>Leaderboard</b>.</p>
                    </div>
                </div>
            </div>
...
<div id="ai-chat-container">
    <div id="ai-chat-window">
        <div class="chat-header">
            <span><i class="fas fa-robot me-2"></i> Asisten PADI PAI</span>
            <button class="btn-close btn-close-white" onclick="toggleChat()"></button>
        </div>
        <div class="chat-body" id="chatBody">
            <div class="msg msg-ai">Halo <strong><?= htmlspecialchars($nama_pengguna) ?></strong>! Ada materi agama yang ingin ditanyakan? Bapak bantu ya! 😊</div>
            <div id="typingIndicator" class="typing">PADI AI sedang berpikir...</div>
        </div>
        <div class="chat-footer">
            <input type="text" id="chatInput" class="form-control form-control-sm" placeholder="Tanya tentang PAI..." onkeypress="handleKeyPress(event)">
...
<script>
    ...
    try {
        const response = await fetch('proses_ai_asisten.php', {
            ...
            body: JSON.stringify({ 
                pesan: pesan,
                mapel: 'pai' // TAMBAHKAN BARIS INI AGAR AI TAHU LOKASINYA
            })
        });
