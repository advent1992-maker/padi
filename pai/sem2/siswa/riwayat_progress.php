...
<head>
    ...
    <title>Riwayat Progress Siswa | PAI</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        body { background-color: #fff5f5; }
        /* Warna Merah Pancasila */
        .header-red { background-color: #00acc1; color: white; padding: 30px 0; }
        ...
        .btn-red { background-color: #00acc1; color: white; }
        .btn-red:hover { background-color: #00acc1; color: white; }
        .text-red { color: #00acc1; }
    </style>
</head>
<body>
