...
<head>
    ...
    <title><?= $materi ? htmlspecialchars($materi['judul']) : 'Materi'; ?> | PAI</title>
    ...
    <style>
        ...
        .result-card { border: 1px solid #dee2e6; border-left: 5px solid #00acc1; padding: 15px; border-radius: 8px; background-color: #f8f9fa; }
...
<nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background-color:#00acc1;">
    <div class="container">
        <a class="navbar-brand fw-bold" href="dashboard.php"><i class="fas fa-mosque me-2"></i>PAI</a>
