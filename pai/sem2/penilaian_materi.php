...
$instrumen_siswa = [
    'A. Aspek Materi PAI' => [
        'Materi agama dalam aplikasi ini mudah saya pahami.',
    ...
    'B. Aspek Kemenarikan & Media' => [
        ...
        'Media ini membuat belajar agama menjadi lebih menyenangkan.'
    ],
    'C. Aspek Manfaat' => [
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">PAI Semester 2 - Belajar Agama Menyenangkan</p>
