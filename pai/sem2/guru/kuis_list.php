<?php
// ======================================================================================
// KUIS_LIST.PHP (SISI GURU) - PAI (Fitur Tampilkan/Sembunyikan Kuis)
// ======================================================================================
...
<head>
    <meta charset="UTF-8">
    <title>Kelola Kuis PAI | GURU</title>
    ...
    <style>
        ...
        .table-pai th { background-color: #2e7d32 !important; color: white; }
    </style>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php"><strong>PAI | GURU</strong></a>
...
<div class="container mt-5">
    <header class="mb-4">
        <h1 class="text-success"><i class="fas fa-mosque me-2"></i> Kelola Soal Kuis PAI</h1>
    ...
    <div class="card card-table mb-5">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="table-pai">
                    <tr>
                        <th class="text-white">#</th>
                        <th class="text-white">Judul Bab Cerita</th>
                        <th class="text-white">Status Kuis</th>
                        <th class="text-white">Kelas</th>
                        <th class="text-center text-white">Jumlah Soal</th>
                        <th class="text-center text-white">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($materi_pribadi)): ?>
                        <tr><td colspan="6" class="text-center p-4">Anda belum membuat materi pribadi PAI.</td></tr>
                    <?php else: $no=1; foreach($materi_pribadi as $m): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <a href="?toggle_id=<?= $m['id'] ?>&status=0" class="btn btn-sm btn-secondary fw-bold rounded-pill px-3">
