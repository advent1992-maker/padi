...
if (isset($_GET['id_guru_target'])) {
    ...
    $_SESSION['id_guru_pilihan'] = $user_id; // Kunci di session agar awet saat pindah halaman
} else {
...
// Penanda apakah sedang mengelola kelas orang lain
...
<head>
    ...
    <title>Dashboard <?php echo ucfirst($role); ?> | PAI</title>
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom py-3 shadow-sm">
    <div class="container">
        <a class="navbar-brand" href="dashboard.php">
            <strong>PAI | <?php echo strtoupper($role); ?></strong>
        </a>
